...
export default function CRMKSAPage() {
  ...
  const fetchLeads = async (p = page) => {
    ...
    try {
      ...
      message.error('فشل تحميل عملاء KSA');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-4">
      ...
      <Row justify="space-between" align="middle">
        <Col>
          ...
          <Text type="secondary">
            {total} عميل — Riyadh & Jeddah Leads
          </Text>
        </Col>
        <Col>
          <Space>
      ...
      {/* Modal — defaultRegion pre-selects Riyadh for new KSA leads */}
      <LeadFormModal
        open={modalOpen}
        lead={editingLead}
